...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SGC.Clinica.Domain.Models.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SGC.Clinica.Domain.Models.Patient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SGC.Clinica.Domain.Models.Professional", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SGC.Clinica.Domain.Models.Schedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SGC.Clinica.Domain.Models.TimeSlot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SGC.Clinica.Domain.Models.Physioterapist", b =>
                {
                    b.HasBaseType("SGC.Clinica.Domain.Models.Professional");
            ...
            modelBuilder.Entity("SGC.Clinica.Domain.Models.Appointment", b =>
                {
                    b.HasOne("SGC.Clinica.Domain.Models.Patient", "Patient")
                        .WithMany()
                    ...
                    b.HasOne("SGC.Clinica.Domain.Models.Professional", "Professional")
                        .WithMany()
            ...
            modelBuilder.Entity("SGC.Clinica.Domain.Models.TimeSlot", b =>
                {
                    ...
                    b.HasOne("SGC.Clinica.Domain.Models.Schedule", "Schedule")
                        .WithMany()
